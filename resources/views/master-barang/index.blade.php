...
@section('content')
 ...
 <button class="btn create-btn btn-primary" data-src="{{ url('master-barang/create') }}" data-title="Tambah">+ Tambah Barang</button>
...
$(function() {
    $('#table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route("master-barang.json") !!}',
        columns: [
        {data: 'DT_RowIndex', searchable: false, orderable: false},
        {data:'nama',name:'master_barang.nama'},
        {data:'kode',name:'master_barang.kode'},
