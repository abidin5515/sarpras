        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Permintaan Selesai</h3>
...
function load(){
      $('#table').DataTable({
        ...
        // "order": [[ 4, "asc" ]],
        ajax: {
            url:'{!! route("permintaan_selesai.json") !!}',
            data: function ( d ) {
         $.each($('.form-filter').serializeArray(), function(i, obj){
              d[obj['name']] = obj['value'];
           });
...
// });
    ...
    $(document).on('click', '.print-excel', function(){
        ...
        var url = '{{ url('excel-permintaan-selesai?dari_tanggal=') }}'+dari_tanggal+'&sampai_tanggal='+sampai_tanggal;
        window.open(url);
    });
