        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Master Merk</h3>
              <div class="card-tools">
 <button class="btn create-btn btn-primary" data-src="{{ url('master-merk/create') }}" data-title="Tambah">+ Tambah Master Merk</button>
...
$(function() {
    $('#table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route("master-merk.json") !!}',
        columns: [
        {data: 'DT_RowIndex', searchable: false, orderable: false},
        {data:'nama',name:'master_merk.nama'},
