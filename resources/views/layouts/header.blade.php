<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #343a40">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a style="color: white" href="{{ url('laporan_catatan_perbaikan') }}" class="nav-link">Laporan</a>
      </li>
    </ul>
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto auo">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          {{-- <div class="dropdown-divider"></div> --}}
          <a href="{{ url('keluar') }}" class="dropdown-item dropdown-footer"><i class="fas fa-sign-out-alt mr-2"></i> Keluar</a>
        </div>
      </li>
      {{-- <li class="nav-item">
