...
class SumberDanaController extends Controller
{
    ...
    protected $dir = "sumber_dana";
    protected $url = "sumber-dana";
    ...
    public function json(){
          $data = SumberDana::select(['sumber_dana.id',
'sumber_dana.nama',
]);
...
$save = $sumber_dana->save();
    ...
    public function select2(Request $req){
        $q = $req->q;
        $data = SumberDana::select(['sumber_dana.id','sumber_dana.nama as text'])->where('nama','like', '%'.$q.'%')->get();
